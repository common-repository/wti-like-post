...
function WtiMostLikedPostsShortcode($args) {
     ...
     if (count($posts) > 0) {
          $most_liked_post .= '<table class="most-liked-posts-table" width="100%">';
          $most_liked_post .= '<tr>';
          $most_liked_post .= '<td>' . __('Title', 'wti-like-post') .'</td>';
          $most_liked_post .= '<td align="center">' . __('Like Count', 'wti-like-post') .'</td>';
          $most_liked_post .= '</tr>';
          ...
          foreach ($posts as $post) {
               ...
               $most_liked_post .= '<td align="center">' . $like_count . '</td>';
               $most_liked_post .= '</tr>';
          }
